...
class AlpacaService:
    ...
    def __init__(self, alpaca_key, alpaca_secret):
        ...
        # unfortunately, need to do a differeent api for the paper trading.
        self.alpaca_trading = tradeapi.REST(alpaca_key, alpaca_secret,
    ...
    def buyStock (self, stock_investment):
        """
        purchases stock from alpaca

        Args:
            stock_investment: a dict of tickers to investment amounts.
        """
